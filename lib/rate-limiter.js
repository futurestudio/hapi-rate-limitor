...
class RateLimiter {
  ...
  constructor (server, options = {}) {
    ...
    this.whitelistedIPs = [].concat(whitelistedIPs)
  ...
  async shouldSkip (request) {
    return this.isDisabledFor(request) || this.hasWhitelistedIp(request) || this.skip(request)
  }
   ...
   * @returns {Boolean}
   */
  hasWhitelistedIp (request) {
    return this.whitelistedIPs.includes(
