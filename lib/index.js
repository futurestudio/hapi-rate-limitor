 ...
 * @returns {Object}
 */
function rateLimit (request, userAttribute, userLimitAttribute) {
...
async function register (server, options = {}) {
  const { redis, userAttribute = 'id', userLimitAttribute = 'rateLimit', ...rest } = options
  ...
  server.ext('onPostAuth', async (request, h) => {
    const { id, limit } = rateLimit(request, userAttribute, userLimitAttribute)
